...
def plot_pointing_in_stars(tgt_coord, pointing, x, norm_vmag):
    ...
    plt.scatter(tgt_coord[0], tgt_coord[1], marker='+', color='r', label='target', linewidths=1)
    plt.scatter(pointing[:,0], pointing[:,1], color='C0', label='actual pointing', alpha=0.5, s=1)
    plt.scatter(pointing[:,0].mean(), pointing[:,1].mean(), marker='+', color='C1', label='pointing mean', alpha=1, linewidths=1)
    ...
    plt.scatter(tgt_coord[0], tgt_coord[1], marker='+', color='r', label='target', s=100, linewidths=1)
    plt.scatter(pointing[:,0], pointing[:,1], color='C0', label='actual pointing', alpha=0.5, s=1)

    plt.scatter(pointing[:,0].mean(), pointing[:,1].mean(), marker='+', color='C1', label='pointing mean', alpha=1, s=100, linewidths=1)
